...
omap3630kunlun_n710e_rev1_config:    unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3630kunlun
	sed -e 's/kunlun_n710e_rev1.h/kunlun.h/' \
	-e '/#include/i #define CONFIG_3630KUNLUN_N710E 1' \
	-e '/#include/i #define CONFIG_3630KUNLUN_N710E_REV1 1'< \
	./include/config.h > ./include/config-2.h; \
	mv ./include/config-2.h ./include/config.h

omap3630kunlun_n710e_rev2_config:    unconfig
	@./mkconfig $(@:_config=) arm omap3 omap3630kunlun
	sed -e 's/kunlun_n710e_rev2.h/kunlun.h/' \
	-e '/#include/i #define CONFIG_3630KUNLUN_N710E 1' \
	-e '/#include/i #define CONFIG_3630KUNLUN_N710E_REV2 1'< \
	./include/config.h > ./include/config-2.h; \
	mv ./include/config-2.h ./include/config.h
